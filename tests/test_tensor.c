...
void test_tensor_data_access(void) {
    ...
    // Write values
    t.data[0] = float_to_bf16(1.0f);
    t.data[1] = float_to_bf16(2.0f);
    t.data[2] = float_to_bf16(3.0f);
    t.data[3] = float_to_bf16(4.0f);
...
void test_tensor_large(void) {
    ...
    ASSERT_NEAR(100.0f, bf16_to_float(t.data[100]), BF16_TOLERANCE);
    ASSERT_NEAR(1000.0f, bf16_to_float(t.data[1000]), BF16_TOLERANCE_LOOSE);
