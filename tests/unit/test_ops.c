...
void test_rmsnorm_basic(void) {
    ...
    ASSERT_NEAR(1.0f / expected_rms, bf16_to_float(((t_bf16*)t_out.data)[0]), BF16_TOLERANCE);
    ASSERT_NEAR(2.0f / expected_rms, bf16_to_float(((t_bf16*)t_out.data)[1]), BF16_TOLERANCE);
    ASSERT_NEAR(3.0f / expected_rms, bf16_to_float(((t_bf16*)t_out.data)[2]), BF16_TOLERANCE);
    ASSERT_NEAR(4.0f / expected_rms, bf16_to_float(((t_bf16*)t_out.data)[3]), BF16_TOLERANCE);
...
void test_rmsnorm_weighted(void) {
    ...
    ASSERT_NEAR(2.0f * 1.0f / expected_rms, bf16_to_float(((t_bf16*)t_out.data)[0]), BF16_TOLERANCE_LOOSE);
    ASSERT_NEAR(2.0f * 4.0f / expected_rms, bf16_to_float(((t_bf16*)t_out.data)[3]), BF16_TOLERANCE_LOOSE);
...
void test_rmsnorm_zero(void) {
    ...
    ASSERT_FALSE(isnan(bf16_to_float(((t_bf16*)t_out.data)[0])));
    ASSERT_FALSE(isinf(bf16_to_float(((t_bf16*)t_out.data)[0])));
...
void test_rope_pos_one(void) {
    ...
    float v0 = bf16_to_float(((t_bf16*)t.data)[0]);
    float v1 = bf16_to_float(((t_bf16*)t.data)[1]);
...
void test_matmul_identity(void) {
    ...
    // A * I = A
    ASSERT_NEAR(1.0f, bf16_to_float(((t_bf16*)t_out.data)[0]), BF16_TOLERANCE);
    ASSERT_NEAR(2.0f, bf16_to_float(((t_bf16*)t_out.data)[1]), BF16_TOLERANCE);
    ASSERT_NEAR(3.0f, bf16_to_float(((t_bf16*)t_out.data)[2]), BF16_TOLERANCE);
    ASSERT_NEAR(4.0f, bf16_to_float(((t_bf16*)t_out.data)[3]), BF16_TOLERANCE);
...
void test_matmul_general(void) {
    ...
    ASSERT_NEAR(22.0f, bf16_to_float(((t_bf16*)t_out.data)[0]), BF16_TOLERANCE_LOOSE);
    ASSERT_NEAR(28.0f, bf16_to_float(((t_bf16*)t_out.data)[1]), BF16_TOLERANCE_LOOSE);
    ASSERT_NEAR(49.0f, bf16_to_float(((t_bf16*)t_out.data)[2]), BF16_TOLERANCE_LOOSE);
    ASSERT_NEAR(64.0f, bf16_to_float(((t_bf16*)t_out.data)[3]), BF16_TOLERANCE_LOOSE);
...
void test_lightning_score_basic(void) {
    ...
    ASSERT_NEAR(1.0f, bf16_to_float(((t_bf16*)t_scores.data)[0]), BF16_TOLERANCE);
    ASSERT_NEAR(0.5f, bf16_to_float(((t_bf16*)t_scores.data)[1]), BF16_TOLERANCE);
    ASSERT_NEAR(1.5f, bf16_to_float(((t_bf16*)t_scores.data)[2]), BF16_TOLERANCE);
...
void test_lightning_score_relu(void) {
    ...
    ASSERT_NEAR(0.0f, bf16_to_float(((t_bf16*)t_scores.data)[0]), BF16_TOLERANCE);
...
void test_silu_basic(void) {
    ...
    // SiLU(0) * 1 = 0
    ASSERT_NEAR(0.0f, bf16_to_float(((t_bf16*)t_out.data)[0]), BF16_TOLERANCE);
    
    // SiLU(2) * 1 ≈ 1.762
    float expected = 2.0f / (1.0f + expf(-2.0f));
    ASSERT_NEAR(expected, bf16_to_float(((t_bf16*)t_out.data)[1]), BF16_TOLERANCE);
...
void test_swiglu(void) {
    ...
    ASSERT_NEAR(silu_2 * 3.0f, bf16_to_float(((t_bf16*)t_out.data)[0]), BF16_TOLERANCE_LOOSE);
